 ...
 * @author Kyle
 */
public class ShowReservedLotSubClass extends DecisionNoStrategy{
    ...
    public void showTable(DBComponents db,User user,JTable jTable1){
        ...
        db.getPst().setString(2, "Reserved"); // Set the lotStatus parameter to "Reserved"
        ...
        Logger.getLogger(ShowReservedLotSubClass.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
}
